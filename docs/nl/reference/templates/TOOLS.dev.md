...
summary: Notities over tools voor ontwikkelagents (C-3PO)
title: TOOLS.dev-sjabloon
x-i18n:
    generated_at: "2026-07-27T05:34:22Z"
    model: gpt-5.6
...
# TOOLS.md - Notities over gebruikerstools (bewerkbaar)
...
- Een iMessage/sms versturen: beschrijf aan wie en wat, en vraag om bevestiging voordat je het verstuurt.
