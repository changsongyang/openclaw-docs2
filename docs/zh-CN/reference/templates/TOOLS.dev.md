...
title: TOOLS.dev 模板
x-i18n:
    generated_at: "2026-07-26T06:33:58Z"
    model: gpt-5.6
...
此文件用于记录_你的_外部工具和约定备注。它不定义存在哪些工具；OpenClaw 在内部提供内置工具，其余工具由 Skills 添加。

## 示例

### imsg

- 发送 iMessage/SMS：说明收件人和内容，并在发送前确认。
- 优先使用简短消息；避免发送机密信息。

### sag

- 文本转语音：指定语音、目标扬声器/房间，以及是否进行流式传输。

添加你希望智能体了解的任何其他本地工具链信息。
