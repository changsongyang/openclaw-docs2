---
read_when:
    - 指向 building-extensions 的旧版链接
summary: 重定向到当前的 Building Plugins 指南
title: 构建插件（重定向）
x-i18n:
    generated_at: "2026-07-26T06:14:51Z"
    model: gpt-5.6
...
此页面已移动。请参阅 [Building Plugins](/zh-CN/plugins/building-plugins)。
