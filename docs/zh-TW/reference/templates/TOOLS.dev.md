...
title: TOOLS.dev 範本
x-i18n:
    generated_at: "2026-07-26T08:13:45Z"
    model: gpt-5.6
...
此檔案用於記錄你對外部工具與慣例的備註。它不會定義有哪些工具；OpenClaw 內部提供內建工具，其餘則由 Skills 新增。

## 範例

### imsg

- 傳送 iMessage/SMS：描述收件者與內容，並在傳送前確認。
- 優先使用簡短訊息；避免傳送機密資訊。

### sag

- 文字轉語音：指定語音、目標喇叭／房間，以及是否要串流播放。
